...
class DescribeBadPartitions:
    def __init__(self, ds_name, distance_measure: str, data_type: str = SyntheticDataType.non_normal_correlated,
        ...
        for file_name, p_label in self.partitions.items():
            ...
            min_id = p_label[SyntheticDataSegmentCols.segment_id].min()
            p_first_seg_end_idx = p_label[p_label[SyntheticDataSegmentCols.segment_id] == min_id][SyntheticDataSegmentCols.end_idx].values[0]
