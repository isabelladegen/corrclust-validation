...
if __name__ == "__main__":
    ...
    corr_threshold = 0.5
    # normal 100%
    calculate_mean_sd_for(distance_measures, internal_measures, SyntheticDataType.normal_correlated, SYNTHETIC_DATA_DIR,
                          DataCompleteness.complete, corr_threshold, ROOT_RESULTS_DIR)

    # normal 70%
    calculate_mean_sd_for(distance_measures, internal_measures, SyntheticDataType.normal_correlated,
                          IRREGULAR_P30_DATA_DIR, DataCompleteness.irregular_p30, corr_threshold, ROOT_RESULTS_DIR)

    # normal 10%
    calculate_mean_sd_for(distance_measures, internal_measures, SyntheticDataType.normal_correlated,
                          IRREGULAR_P90_DATA_DIR, DataCompleteness.irregular_p90, corr_threshold, ROOT_RESULTS_DIR)

    # non-normal 100%
    calculate_mean_sd_for(distance_measures, internal_measures, SyntheticDataType.non_normal_correlated,
                          SYNTHETIC_DATA_DIR, DataCompleteness.complete, corr_threshold, ROOT_RESULTS_DIR)
