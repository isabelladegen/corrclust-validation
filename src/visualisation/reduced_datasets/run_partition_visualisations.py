...
from src.utils.configurations import GENERATED_DATASETS_FILE_PATH, ROOT_REDUCED_SYNTHETIC_DATA_DIR, \
    DataCompleteness, ROOT_REDUCED_RESULTS_DIR, get_data_dir, get_root_folder_for_reduced_cluster, \
...
if __name__ == "__main__":
    # line plots of jaccard index, n wrong clusters, n observation shifted
    ...
    for dropped_cluster in n_dropped_clusters:
        ...
        partition_visualisation(data_dirs=data_dirs, dataset_types=data_types, run_names=run_names,
                                root_results_dir=results_dir, distance_measure=distance_measures[0],
