...
SYNTHETIC_DATA_DIR = path.join(ROOT_DIR, 'csts/exploratory')
...
CONF_ROOT_REDUCED_RESULTS_DIR = path.join(CONF_ROOT_RESULTS_DIR, "reduced-data")
...
DENDROGRAM_IMAGE = 'dendrogram.png'
