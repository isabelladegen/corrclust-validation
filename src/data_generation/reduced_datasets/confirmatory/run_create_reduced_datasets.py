...
from src.utils.configurations import ROOT_REDUCED_SYNTHETIC_DATA_DIR, DataCompleteness, CONFIRMATORY_DATASETS_FILE_PATH, \
    CONFIRMATORY_SYNTHETIC_DATA_DIR
...
if __name__ == "__main__":
    ...
    _root_reduced_data_dir = ROOT_REDUCED_SYNTHETIC_DATA_DIR
