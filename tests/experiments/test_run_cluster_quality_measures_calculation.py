...
from src.experiments.run_cluster_quality_measures_calculation import read_clustering_quality_measures, \
    run_internal_measure_calculation_for_dataset, load_all_clustering_data_for_subjects_and_data_type
...
def test_can_run_calculation_for_internal_measures_on_all_datasets(tmp_path):
    ...
    data_dict, gt_labels_dict, partitions_dict = load_all_clustering_data_for_subjects_and_data_type(
        run_ids=runs, data_type=data_type, data_dir=test_data_dir)
