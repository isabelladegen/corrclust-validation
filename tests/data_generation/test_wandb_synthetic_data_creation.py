...
def test_wandb_synthetic_data_creation_with_loadings_correlation_method():
    ...
    assert_that(summary["max MAE RAW"], is_(1.001))  # not correlated so highest error
    ...
    assert_that(summary["max MAE NC"], is_(0.215))
    ...
    assert_that(summary["max MAE NN"], is_(0.216))
    ...
    assert_that(summary["max MAE RS"], is_(0.289))  # higher than any of the correlated version
