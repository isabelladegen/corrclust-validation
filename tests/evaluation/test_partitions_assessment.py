...
def test_loads_all_partitions_for_each_datasets_ordered_by_worst_jaccard_to_best():
    # read all datasets
    assert_that(len(pal1ref.generated_ds), is_(2))
...
def test_plot_descriptive_statistics_for_partitions_for_column_for_l2_measure():
    l2_results_dir = internal_measure_results_dir_for_data_type_and_distance_measures(overall_dataset_name, data_type,
                                                                                      results_dir,
...
def test_plot_descriptive_statistics_for_partitions_for_column_for_l1_measure():
    l1_results_dir = internal_measure_results_dir_for_data_type_and_distance_measures(overall_dataset_name, data_type,
                                                                                      results_dir,
